...
function toggle(div_id) {
	...
	if ( el.style.display == 'none' ) {	
	    ...
	    div = document.getElementById('menuprincipal');
...
function blanket_size(popUpDivVar) {
    ...
    var altura = parseInt(popUpDiv.style.height);
	popUpDiv_height=blanket_height/2-(altura/2);//150 is half popup's height
...
function window_pos(popUpDivVar) {
	...
	var popUpDiv = document.getElementById(popUpDivVar);
	 var anchura = parseInt(popUpDiv.style.width);
	window_width=window_width/2-(anchura/2);//150 is half popup's width
...
{var usuario = form.edtUsuario.value;
 var contrasena = form.edtContrasena.value;
 if(usuario=='' || contrasena=='')
 {alert('Ingrese usuario y/o contraseña'); return false;}
return true;}